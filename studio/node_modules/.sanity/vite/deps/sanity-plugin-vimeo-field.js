...
// node_modules/sanity-plugin-vimeo-field/dist/index.esm.js
var import_jsx_runtime2 = __toESM(require_jsx_runtime());
var import_react2 = __toESM(require_react());

// node_modules/sanity-plugin-vimeo-field/node_modules/@sanity/icons/dist/index.js
...
// node_modules/sanity-plugin-vimeo-field/dist/index.esm.js
var DataFetcher = (props) => {
  const { accessToken, onSuccess, fields } = props;
  const [vimeoId, setVimeoId] = (0, import_react2.useState)("");
  const [isFetching, setIsFetching] = (0, import_react2.useState)(false);
  const [errorMsg, setErrorMsg] = (0, import_react2.useState)("");
  let vimeoFields;
  let url = "https://api.vimeo.com/videos/".concat(vimeoId, "?fields=name,play,pictures,files");
  if (fields == null ? void 0 : fields.length) {
    vimeoFields = fields == null ? void 0 : fields.join(",");
    url += ",".concat(vimeoFields);
  }
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (data == null ? void 0 : data.name) {
        ...
        setErrorMsg(data == null ? void 0 : data.error);
      }
      setIsFetching(false);
    } catch (error) {
  ...
  return (0, import_jsx_runtime2.jsxs)(Stack, { children: [
    !accessToken && (0, import_jsx_runtime2.jsxs)(Inline, { space: [2], children: [
      (0, import_jsx_runtime2.jsx)(Text, { size: 2, children: "No" }),
      (0, import_jsx_runtime2.jsx)(Code, { size: 2, children: "SANITY_STUDIO_VIMEO_ACCESS_TOKEN" }),
      (0, import_jsx_runtime2.jsx)(Text, { size: 2, children: "found!" })
    ] }),
    accessToken && // Fetcher
    (0, import_jsx_runtime2.jsxs)(Inline, { space: [2], children: [
      ...
      isFetching && (0, import_jsx_runtime2.jsx)(Spinner, { muted: true })
    ] }),
    errorMsg && (0, import_jsx_runtime2.jsxs)("p", { style: { color: "red" }, children: [
      "Error: ",
      errorMsg
    ] })
  ] });
};
var VideoInput = (config, props) => {
  var _a, _b, _c, _d;
  const { fields } = (_a = props == null ? void 0 : props.schemaType) == null ? void 0 : _a.options;
  ...
  return (0, import_jsx_runtime2.jsxs)(Card, { children: [
    !value && (0, import_jsx_runtime2.jsx)(DataFetcher, { accessToken, onSuccess: setVimeoData, fields }),
    (0, import_jsx_runtime2.jsx)("div", { children: value == null ? void 0 : value.error }),
    ((_c = (_b = value == null ? void 0 : value.pictures) == null ? void 0 : _b.sizes) == null ? void 0 : _c.length) && (0, import_jsx_runtime2.jsxs)(Stack, { space: 4, children: [
      (0, import_jsx_runtime2.jsxs)(Stack, { space: 3, children: [
        (0, import_jsx_runtime2.jsx)(Text, { size: 1, weight: "semibold", children: "ID" }),
        (0, import_jsx_runtime2.jsx)(TextInput, { fontSize: 2, padding: 3, readOnly: true, value: value == null ? void 0 : value.id })
      ] }),
      (0, import_jsx_runtime2.jsxs)(Stack, { space: 3, children: [
        (0, import_jsx_runtime2.jsx)(Text, { size: 1, weight: "semibold", children: "Thumbnail" }),
        (0, import_jsx_runtime2.jsx)(
          "img",
          {
            src: (_d = value.pictures.sizes[0]) == null ? void 0 : _d.link,
      ...
      (0, import_jsx_runtime2.jsxs)(Stack, { space: 3, children: [
        (0, import_jsx_runtime2.jsx)(Text, { size: 1, weight: "semibold", children: "Title" }),
        (0, import_jsx_runtime2.jsx)(TextInput, { fontSize: 2, padding: 3, readOnly: true, value: value == null ? void 0 : value.name })
      ] }),
      (0, import_jsx_runtime2.jsx)(Inline, { space: [2], children: (0, import_jsx_runtime2.jsx)(
        Button,
        {
          text: "Reset",
          icon: TrashIcon,
...
var vimeoField = definePlugin((userConfig) => {
...
//# sourceMappingURL=sanity-plugin-vimeo-field.js.map
